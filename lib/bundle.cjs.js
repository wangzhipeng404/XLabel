...
var Shape$1 = /** @class */ (function () {
    ...
    Shape.prototype.paint = function (canvas) {
        ...
        this.points.foreach(function (i, p) {
            _this.drawPoint(canvas, p, i);
        });
    };
    Shape.prototype.drawPoint = function (canvas, pos, index) {
    ...
    Shape.prototype.drawLine = function (canvas) {
        if (!this.el) {
            this.el = canvas.line();
        }
        var points = [];
    ...
    Shape.prototype.drawReact = function (canvas) {
        if (!this.el) {
            this.el = canvas.rect();
        }
        var p0 = this.points.get(0);
    ...
    Shape.prototype.drawCircle = function (canvas) {
        if (!this.el) {
    ...
    Shape.prototype.drawPolygon = function (canvas) {
        if (!this.el) {
...
var Canvas = /** @class */ (function () {
    ...
    Canvas.prototype.editing = function () {
        return this.mode === 'EDIT';
    };
    Canvas.prototype.moving = function () {
        return this.mode === 'MOVE';
    };
    Canvas.prototype.continuous = function () {
        return this.continuousMode;
    };
    Canvas.prototype.setContinuousMode = function (flag) {
        this.continuousMode = flag;
    };
    Canvas.prototype.setImg = function (url) {
        this.canvas.clear();
        this.shapes = new HashTable();
        this.canvas.image(url).size('100%', '100%');
    };
    Canvas.prototype.setConfig = function (conf) {
        this.config = __assign(__assign({}, this.config), conf);
    };
    Canvas.prototype.setCreateMode = function (type) {
    ...
    Canvas.prototype.mousePressEvent = function (ev) {
    ...
    Canvas.prototype.mouseMoveEvent = function (ev) {
        var pos = this.transformPos(ev);
        this.cursor = pos;
        if (this.drawing()) {
            if (!this.current)
    ...
    Canvas.prototype.createShape = function (pos) {
    ...
    Canvas.prototype.moveShape = function (pos) {
        var _this = this;
        ...
        this.current.points.foreach(function (i, p) {
            ...
            _this.current.points.set(i, newPoint);
        });
        this.prevMovePoint = pos;
        this.current.paint(this.canvas);
    };
    Canvas.prototype.editShape = function (pos) {
        var index = this.selectedDataset.index;
        this.current.points.set(index, pos);
        this.current.paint(this.canvas);
    };
    Canvas.prototype.transformPos = function (ev) {
    ...
    Canvas.prototype.finalise = function () {
        if (this.current) {
            this.current.close();
    ...
    Canvas.prototype.reRender = function () {
        var _this = this;
        console.log('render');
        this.shapes.foreach(function (k, v) {
            v.paint(_this.canvas);
        });
    };
    return Canvas;
}());

    ...
    ***/
    ...
    var Shape$1 = /** @class */ (function () {
        ...
        Shape.prototype.removeElement = function () {
            ...
            this.vertexs.forEach(function (p) { return p.remove(); });
            this.vertexs = [];
        };
        Shape.prototype.paint = function (canvas, originPoint, scale) {
            var _this = this;
            ...
            this.points.foreach(function (i, p) {
                _this.drawPoint(canvas, originPoint, scale, p, i);
            });
        };
        Shape.prototype.drawPoint = function (canvas, originPoint, scale, pos, index) {
            if (!this.vertexs[index]) {
                this.vertexs[index] = canvas.circle();
            }
            var p = pos.add(originPoint).scale(scale);
        ...
        Shape.prototype.drawLine = function (canvas, originPoint, scale) {
            if (!this.el) {
                this.el = canvas.line();
            }
            var points = [];
            this.points.foreach(function (i, p) {
                var pos = p.add(originPoint).scale(scale);
                points.push(pos.x + "," + pos.y);
            });
            this.el.plot(points.join(',')).attr({
        ...
        Shape.prototype.drawReact = function (canvas, originPoint, scale) {
            if (!this.el) {
                this.el = canvas.rect();
            }
            var p0 = this.points.get(0).add(originPoint).scale(scale);
            var p1 = this.points.get(1).add(originPoint).scale(scale);
        ...
        Shape.prototype.drawCircle = function (canvas, originPoint, scale) {
            if (!this.el) {
        ...
        Shape.prototype.drawPolygon = function (canvas, originPoint, scale) {
            if (!this.el) {
    ...
    var XLabel = /** @class */ (function () {
        ...
        XLabel.prototype.reRender = function () {
            ...
            this.shapes.foreach(function (k, v) {
                v.paint(_this.canvas, _this.originPoint, _this.scale);
            });
        };
        return XLabel;
    }());

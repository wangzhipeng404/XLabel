...
(function (global, factory) {
    ...
    ***/
    ...
    var Shape$1 = /** @class */ (function () {
        function Shape(colorKey, shapeType, label, groupId, otherData) {
        ...
        Shape.prototype.copy = function (colorKey) {
            var copyed = new Shape(colorKey, this.shapeType, this.label, this.groupId, this.otherData);
    ...
    var Point$1 = /** @class */ (function () {
        ...
        Point.prototype.paint = function (canvas) {
            var $point = canvas.circle(5).attr({
                cx: this.x,
                cy: this.y,
    ...
    var XLabel = /** @class */ (function () {
        function XLabel($parent, conf) {
            ...
            $parent.addEventListener('mousewheel', function (e) {
                if (e.ctrlKey) {
                    _this.zoom(e.deltaY, _this.transformPos(e));
                    e.returnValue = false;
                }
            }, { passive: false });
        ...
        XLabel.prototype.registerShutcuts = function () {
            ...
            var shortcutCtrl = stringifyKey("ctrl");
            var shortcutRectangle = stringifyKey("ctrl", "r");
            var shortcutCircle = stringifyKey("ctrl", "c");
            var shortcutpolyon = stringifyKey("ctrl", "p");
            keyboard.addListener(createShortcuts((_a = {},
                _a[shortcutRectangle] = function (e, combo) {
                    e.preventDefault();
        ...
        XLabel.prototype.setImg = function (path) {
            var _this = this;
            if (!path)
                return;
            this.clean();
            ...
            if (img.complete) {
                ...
                img.onload = function () {
                    ...
                    _this.pixmapWidth = _this.canvasWidth;
                    _this.pixmapHeight = _this.canvasWidth / img.width * img.height;
        ...
        XLabel.prototype.setData = function () {
        };
        XLabel.prototype.getData = function () {
        };
        XLabel.prototype.zoom = function (deltaY, pos) {
            if (deltaY < 0) {
        ...
        XLabel.prototype.mousePressEvent = function (ev) {
            ...
            if (this.outOfPixmap(pos))
                return;
            var _a = ev.target, nodeName = _a.nodeName, dataset = _a.dataset;
        ...
        XLabel.prototype.createShape = function (pos) {
            if (this.current) { // 如果有当前图形则处理当前图形
                var tooClose = closeEnough$1(pos, this.current.points.get(0), 5);
                ...
                this.current = new Shape$1(colorKey, this.createMode);
                this.current.addPoint(pos);
        ...
        XLabel.prototype.moveLabelImage = function (pos) {
            var offsetPoint = pos.sub(this.prevMovePoint);
        ...
        XLabel.prototype.reRender = function () {
            var _this = this;
        ...
        XLabel.prototype.paint = function (shape) {
            ...
            shape.points.foreach(function (i, p) {
                _this.drawPoint(shape, i);
            });
        };
        XLabel.prototype.drawPoint = function (shape, index) {
        ...
        XLabel.prototype.removeElement = function (shape) {
            var _a, _b;
            (_a = this.elements.get(shape.colorKey)) === null || _a === void 0 ? void 0 : _a.remove();
            (_b = this.vertexs.get(shape.colorKey)) === null || _b === void 0 ? void 0 : _b.forEach(function (el) {
                el.remove();
            });
